...
export declare class IonRouterOutlet implements OnDestroy, OnInit {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<IonRouterOutlet, "ion-router-outlet", ["outlet"], { 'animated': "animated", 'swipeGesture': "swipeGesture" }, { 'stackEvents': "stackEvents", 'activateEvents': "activate", 'deactivateEvents': "deactivate" }, never>;
}
